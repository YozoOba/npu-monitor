...
def get_color(avg):
    ...
    if avg >= 40.0:
        ...
        return YELLOW       # 高：20-40
    elif avg >= 10.0:
        return GREEN        # 中：10-20
    else:
        return BLUE         # 低：0-10
...
def print_heatmap_matrix(start_date, end_date, all_data):
    ...
    print(summary_row)
    print('='*95)
    print(f"Legend: {GRAY}--{RESET} (No Data) | {BLUE}00-09{RESET} (Low) | {GREEN}10-19{RESET} (Medium) | {YELLOW}20-39{RESET} (High) | {RED}40-99{RESET} (Very High)")
