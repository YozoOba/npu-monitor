...
docker_args=(
    ...
    -e "NPU_CONSOLE_MAX_EXPORT_DAYS=${NPU_CONSOLE_MAX_EXPORT_DAYS:-31}"
    -e "NPU_CONSOLE_REPORT_TIMEOUT=${NPU_CONSOLE_REPORT_TIMEOUT:-120}"
    -e "NPU_CONSOLE_MAX_REPORT_DAYS=${NPU_CONSOLE_MAX_REPORT_DAYS:-180}"
